...
\copy pelicula FROM 'devel/Desarrollo Desafio latam/base_datos/desafio2/peliculas.csv' CSV HEADER ; 
\copy reparto FROM 'devel/Desarrollo Desafio latam/base_datos/desafio2/reparto.csv' CSV HEADER ;
